        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12  grid-margin stretch-card">
              <div class="card">
                <form class="forms-sample" method="POST" action="{{route('store_contactsetting')}}" enctype="multipart/form-data">
                    @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"   name="barnch_name" class="form-control" id="barnch_name">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"   maxlength="12" name="phone1" class="form-control" id="phone1">
