    ...
    <table role="presentation" cellspacing="0" cellpadding="0" width="100%" style="margin: auto;">
        <div class="tablestart">
            ...
            <tr>
                <td>
                    <div class="hedding">
                            <h1 style="text-align: center;">New Inquery is Comming </h1>
                            <div class="contain1">
                                <p> Hi ,Admin </p>
                            </div>
                        <div class="contain2">
                            <p> New Inquery Is Coming form User {{$username}} for {{$location}} Location</p>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="hedding">
                        <div class="contain2">
                            <label style="font-size:15px !important;font-style:bold !important;">Name : </label> {{$username}}
            ...
            <tr>
                <td>
                    <div class="hedding">
                        <div class="contain2">
                            <label style="font-size:15px !important;font-style:bold !important;">Option : </label> {{$option}}
